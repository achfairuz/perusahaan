    ...
    <header>
        <nav class="navbar navbar-expand-md navbar-dark bg-dark fixed-top" aria-label="Fourth navbar example" style="z-index: 100;">
            <div class="container-fluid">
                <a class="navbar-brand fw-bold" href="#"><img src="../aset/logo.png" alt="logo" class="img img-fluid me-2" style="max-width: 40px; max-height: 40px;">Bismillah Sejahtera</a>
            ...
            <nav id="sidebarMenu" class="col-md-3 col-lg-2 d-md-block sidebar collapse " style="background-color: #2A2F34; z-index: 99;">
                <div class="position-fixed">
                    <ul class="nav flex-column mt-3">
                        ...
                        <li class="nav-item">
                            <a class="nav-link text-color <?php if ($page == 'absensiKaryawan' || $page == 'formAbsensi' || $page == 'updateAbsensi') echo 'active'; ?>" aria-current="page" href="?page=absensiKaryawan">
                                <span data-feather="calendar"></span>
                                Absensi Karyawan
                            </a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link text-color <?php if ($page == 'showKaryawan' || $page == 'formAddKaryawan' || $page == 'formUpdateKaryawan') echo 'active'; ?>" href="?page=showKaryawan">
                                <span data-feather="briefcase"></span>
                                Karyawan
                            </a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link text-color <?php if ($page == 'pendapatancabang') echo 'active'; ?>" href="?page=pendapatancabang">
                        ...
                        <li class="nav-item">
                            <a class="nav-link text-color <?php if ($page == 'product' || $page == 'addProduk' || $page == 'updateProduk') echo "active" ?>" href="?page=product">
                                <span data-feather="box"></span>
                                Produk
                            </a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link text-color <?php if ($page == 'cuti' || $page == 'formCuti' || $page == 'update_cuti') echo 'active' ?>" href="?page=cuti">
