...
<div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom mt-3">
    <h1 class="h2 text-mainColor fw-bold">Karyawan</h1>
    <div class="btn-toolbar mb-2 mb-md-0">
        <a href="?page=formAddKaryawan">
            <button type="button" id="tambah" class="btn btn-sm text-color btn-outline-secondary">
                <span data-feather="plus"></span> Tambah Karyawan
            </button>
        </a>
    </div>
</div>
    ...
    <table class="table table-striped table-sm text-center">
        <thead class="border-color">
            <tr>
                ...
                <th scope="col" class="px-3">Nama Karyawan</th>
        ...
        <tbody>
            ...
            $username = $_SESSION['username'];
            $no = 1;
            $sql = "SELECT user.*, cabang.nama_cabang FROM user, cabang WHERE user.id_cabang = cabang.id_cabang AND user.role = 'karyawan' AND user.id_cabang = '$id_cabang' ORDER BY user.username ASC";
            ...
            ?>
                <tr>
                    ...
                    <td class="p-3">
                        <a href="?page=formUpdateKaryawan&username=<?php echo ($a['username']); ?>">
